...
comment on column guests.country is
  'Country the guest travels from: Australia, Malaysia, Vietnam, Indonesia or Misc countries. Null if not recorded.';
...
comment on column guests.invite_or_not is
  'Where the guest sits on the invite list: Invite or Not 100%. Null until decided.';
