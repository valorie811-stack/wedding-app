...
import { headcount } from "@/lib/guests";
...
export const SEED_TASKS = [
  { id: "seed-t1", code: "HP", title: "Confirm banquet hall deposit", due: "2026-07-15", status: "in_progress", assignee: "Couple", vendorId: "seed-v1" },
  { id: "seed-t2", code: "HP", title: "Order mâm quả trays for Lễ Ăn Hỏi", due: "2027-08-01", status: "todo", assignee: "Groom's family", eventId: "seed-e2" },
  { id: "seed-t3", code: "HP", title: "Book áo dài fittings", due: "2026-09-01", status: "todo", assignee: "Bride", vendorId: "seed-v3" },
  { id: "seed-t4", code: "HP", title: "Finalise Lễ Cưới run sheet", due: "2027-09-20", status: "todo", assignee: "Planner", eventId: "seed-e3" },
  { id: "seed-t5", code: "KK", title: "Verify Halal certification for Day 2 venue", due: "2026-08-01", status: "todo", assignee: "Planner", vendorId: "seed-v6", eventId: "seed-e5" },
  ...
  { id: "seed-t8", code: "KK", title: "Arrange transport for Halal lunch guests", due: "2027-09-15", status: "todo", assignee: "Planner", vendorId: "seed-v8", eventId: "seed-e5" },
...
export const SEED_GUESTS = [
  { id: "seed-g1", full_name: "Nguyễn Văn An", side: "bride", plus_one: true, plus_one_name: "Nguyễn Thị Mai", dietary: [], notes: "", country: "Vietnam", category: "Family", invite_or_not: "Invite", party_size: 4 },
  { id: "seed-g2", full_name: "Trần Thị Bình", side: "bride", plus_one: false, plus_one_name: "", dietary: ["vegetarian"], notes: "", country: "Vietnam", category: "Family", invite_or_not: "Invite" },
  { id: "seed-g3", full_name: "Lê Hoàng Cường", side: "groom", plus_one: true, plus_one_name: "Phạm Thị Hương", dietary: [], notes: "", country: "Australia", category: "Friends", invite_or_not: "Invite", party_size: 2 },
  { id: "seed-g4", full_name: "Phạm Thu Dung", side: "bride", plus_one: false, plus_one_name: "", dietary: [], notes: "", country: "Vietnam", category: "Friends", invite_or_not: "Invite" },
  { id: "seed-g5", full_name: "Đỗ Minh Đức", side: "groom mom", plus_one: true, plus_one_name: "Trần Thị Ngọc", dietary: [], notes: "", country: "Australia", category: "Family", invite_or_not: "Invite" },
  { id: "seed-g6", full_name: "Vũ Thị Hà", side: "bride", plus_one: false, plus_one_name: "", dietary: [], notes: "", country: "Misc countries", category: "Work", invite_or_not: "Invite", party_size: 3 },
  { id: "seed-g7", full_name: "Hoàng Văn Hải", side: "groom", plus_one: false, plus_one_name: "", dietary: [], notes: "Awaiting reply", country: "Australia", category: "Friends", invite_or_not: "Not 100%" },
  { id: "seed-g8", full_name: "Bùi Thị Lan", side: "bride", plus_one: true, plus_one_name: "Bùi Văn Tú", dietary: [], notes: "", country: "Vietnam", category: "Family", invite_or_not: "Not 100%" },
  { id: "seed-g9", full_name: "Tan Wei Ming", side: "groom", plus_one: true, plus_one_name: "Tan Siew Lan", dietary: [], notes: "", country: "Malaysia", category: "Family", invite_or_not: "Invite", party_size: 6 },
  { id: "seed-g10", full_name: "Lim Mei Ling", side: "bride", plus_one: false, plus_one_name: "", dietary: [], notes: "", country: "Malaysia", category: "Family", invite_or_not: "Invite" },
  { id: "seed-g11", full_name: "Wong Kah Wai", side: "groom", plus_one: true, plus_one_name: "Wong Pui Yee", dietary: [], notes: "", country: "Malaysia", category: "Friends", invite_or_not: "Invite" },
  { id: "seed-g12", full_name: "Siti Nurhaliza", side: "bride", plus_one: false, plus_one_name: "", dietary: ["halal"], notes: "", country: "Malaysia", category: "Work", invite_or_not: "Invite", party_size: 1 },
  { id: "seed-g13", full_name: "Ahmad Faizal", side: "groom", plus_one: true, plus_one_name: "Nurul Ain", dietary: ["halal"], notes: "", country: "Indonesia", category: "Friends", invite_or_not: "Invite" },
  { id: "seed-g14", full_name: "Chong Li Hua", side: "bride", plus_one: false, plus_one_name: "", dietary: [], notes: "Attending both KK events", country: "Malaysia", category: "Family", invite_or_not: "Invite", party_size: 5 },
  { id: "seed-g15", full_name: "Goh Boon Hai", side: "groom dad", plus_one: false, plus_one_name: "", dietary: [], notes: "", country: "Malaysia", category: "Work", invite_or_not: "Invite" },
  { id: "seed-g16", full_name: "Aishah Binti Omar", side: "bride", plus_one: true, plus_one_name: "Omar Bin Yusof", dietary: ["halal"], notes: "", country: "Indonesia", category: "Family", invite_or_not: "Invite", party_size: 3 },
  { id: "seed-g17", full_name: "James Carter", side: "groom", plus_one: true, plus_one_name: "Sarah Carter", dietary: [], notes: "", country: "Australia", category: "Friends", invite_or_not: "Not 100%" },
  { id: "seed-g18", full_name: "Emily Watson", side: "bride", plus_one: false, plus_one_name: "", dietary: ["vegan"], notes: "", country: "Australia", category: "Work", invite_or_not: "Invite" },
];
...
// matching what lib/data.js builds from Postgres. Derived from the rows above
// rather than hand-listed beside them: it used to be a second, parallel copy of
// the same facts (HP reception 6/1/1; KK banquet 5 confirmed + 2 pending; KK
// Halal lunch 3 confirmed + 1 pending), and the two drifting apart would put
// the dashboard and the RSVP page on different numbers for the same event.
//
// `heads` is what the invitation actually brings, so the dashboard can report
// people as well as replies. Same field the live mapper attaches.
const SEED_EVENT_CODE = new Map(SEED_EVENTS.map((e) => [e.id, e.code]));
const SEED_GUEST_BY_ID = new Map(SEED_GUESTS.map((g) => [g.id, g]));
export const SEED_RSVP = SEED_GUEST_EVENTS.map((ge) => ({
  code: SEED_EVENT_CODE.get(ge.event_id),
  status: ge.status,
  heads: headcount(SEED_GUEST_BY_ID.get(ge.guest_id)),
  // Who the reply is from, so the dashboard can count a household once across
  // the several events it is invited to. Same field the live mapper attaches.
  guestId: ge.guest_id,
}));
