...
export const SEED_BUDGET_ITEMS = [
  { id: "seed-bi1", code: "HP", currency: "VND", category: "Venue", label: "Banquet hall deposit", actual: 60000000 },
  ...
  { id: "seed-bi8", code: "HP", currency: "VND", category: "Photography", label: "Photo + video package", actual: 40000000 },
  { id: "seed-bi9", code: "HP", currency: "VND", category: "Florals", label: "Ceremony flowers deposit", actual: 12000000 },
  { id: "seed-bi10", code: "KK", currency: "MYR", category: "Venue", label: "Ballroom deposit", actual: 8000 },
  ...
  { id: "seed-bi13", code: "KK", currency: "MYR", category: "Catering", label: "Halal lunch", actual: 12000 },
  ...
  { id: "seed-bi16", code: "KK", currency: "MYR", category: "Photography", label: "Photo + video", actual: 12000 },
...
export const SEED_GUESTS = [
  { id: "seed-g1", full_name: "Nguyễn Văn An", email: "an@example.com", phone: "+84 90 111 2233", side: "bride", plus_one: true, dietary: [], notes: "" },
  { id: "seed-g2", full_name: "Trần Thị Bình", email: "binh@example.com", phone: "", side: "bride", plus_one: false, dietary: ["vegetarian"], notes: "" },
  { id: "seed-g3", full_name: "Lê Hoàng Cường", email: "cuong@example.com", phone: "", side: "groom", plus_one: true, dietary: [], notes: "" },
  { id: "seed-g4", full_name: "Phạm Thu Dung", email: "dung@example.com", phone: "", side: "bride", plus_one: false, dietary: [], notes: "" },
  { id: "seed-g5", full_name: "Đỗ Minh Đức", email: "duc@example.com", phone: "", side: "groom", plus_one: true, dietary: [], notes: "" },
  { id: "seed-g6", full_name: "Vũ Thị Hà", email: "ha@example.com", phone: "", side: "bride", plus_one: false, dietary: [], notes: "" },
  { id: "seed-g7", full_name: "Hoàng Văn Hải", email: "hai@example.com", phone: "", side: "groom", plus_one: false, dietary: [], notes: "Awaiting reply" },
  { id: "seed-g8", full_name: "Bùi Thị Lan", email: "lan@example.com", phone: "", side: "bride", plus_one: true, dietary: [], notes: "" },
  { id: "seed-g9", full_name: "Tan Wei Ming", email: "weiming@example.com", phone: "+60 12 345 6789", side: "groom", plus_one: true, dietary: [], notes: "" },
  { id: "seed-g10", full_name: "Lim Mei Ling", email: "meiling@example.com", phone: "", side: "bride", plus_one: false, dietary: [], notes: "" },
  { id: "seed-g11", full_name: "Wong Kah Wai", email: "kahwai@example.com", phone: "", side: "groom", plus_one: true, dietary: [], notes: "" },
  { id: "seed-g12", full_name: "Siti Nurhaliza", email: "siti@example.com", phone: "", side: "bride", plus_one: false, dietary: ["halal"], notes: "" },
  { id: "seed-g13", full_name: "Ahmad Faizal", email: "faizal@example.com", phone: "", side: "groom", plus_one: true, dietary: ["halal"], notes: "" },
  { id: "seed-g14", full_name: "Chong Li Hua", email: "lihua@example.com", phone: "", side: "bride", plus_one: false, dietary: [], notes: "Attending both KK events" },
  { id: "seed-g15", full_name: "Goh Boon Hai", email: "boonhai@example.com", phone: "", side: "groom", plus_one: false, dietary: [], notes: "" },
  { id: "seed-g16", full_name: "Aishah Binti Omar", email: "aishah@example.com", phone: "", side: "bride", plus_one: true, dietary: ["halal"], notes: "" },
  { id: "seed-g17", full_name: "James Carter", email: "james@example.com", phone: "", side: "groom", plus_one: true, dietary: [], notes: "" },
  { id: "seed-g18", full_name: "Emily Watson", email: "emily@example.com", phone: "", side: "bride", plus_one: false, dietary: ["vegan"], notes: "" },
];
...
export const SEED_MOODBOARD = [
  { id: "seed-mb1", code: "HP", board: "Colour palette", title: "Red & gold", image_url: "https://picsum.photos/seed/hp-palette/600/400", swatches: ["#be123c", "#d4af37", "#fee2e2"], notes: "Auspicious reds with gold accents" },
  { id: "seed-mb2", code: "HP", board: "Florals", title: "Ceremony arch", image_url: "https://picsum.photos/seed/hp-florals/600/400", swatches: ["#e11d48", "#fb7185", "#fde68a"], notes: "Roses + orchids" },
  { id: "seed-mb3", code: "HP", board: "Décor", title: "Banquet tablescape", image_url: "https://picsum.photos/seed/hp-decor/600/400", swatches: ["#9f1239", "#d4af37"], notes: "Round tables, gold chargers" },
  { id: "seed-mb4", code: "KK", board: "Colour palette", title: "Teal & gold", image_url: "https://picsum.photos/seed/kk-palette/600/400", swatches: ["#0d9488", "#d4af37", "#ccfbf1"], notes: "Coastal teal with warm gold" },
  { id: "seed-mb5", code: "KK", board: "Florals", title: "Tropical blooms", image_url: "https://picsum.photos/seed/kk-florals/600/400", swatches: ["#14b8a6", "#f59e0b", "#fca5a5"], notes: "Hibiscus + frangipani" },
];
